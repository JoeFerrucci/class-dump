class ClassDump < Formula
  ...
  homepage "http://joeferrucci.info"

  stable do
    url "https://github.com/JoeFerrucci/class-dump/archive/3.5.tar.gz"
    ...
    # https://github.com/JoeFerrucci/class-dump/pull/58
  ...
  head do
    url "https://github.com/JoeFerrucci/class-dump.git"

    # Removes the last references to libcrypto.
    patch do
      url "https://patch-diff.githubusercontent.com/raw/JoeFerrucci/class-dump/pull/58.diff"
